...
/**
 * creates the thumbnail of the specified image
 * 
 * @param $img the image thumb array to process
 * @return path of new thumbnail if successful, false otherwise
 */
    public function create_thumb($img){
        ...
        $new_file_path.= $img['append'].'_'.$orig_file_name.".jpg";
